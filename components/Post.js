...
const Post = ({ post, modalPost }) => {
  ...
  return (
    <div
      ...
      ${modalOpen && modalPost && "overflow-y-auto h-full !pt-0"}
      space-y-2 py-2.5 border border-gray-300 dark:border-none`}
    >
      <div className={`flex items-center px-2.5 cursor-pointer ${modalPost && "sticky top-0 z-10 bg-white py-2.5 dark:bg-[#1d2226] "}`}>
